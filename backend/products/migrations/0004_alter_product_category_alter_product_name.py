...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0003_alter_product_category_alter_product_collection_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='product',
            name='category',
            field=models.CharField(choices=[('T-Shirt', 'T-Shirt'), ('Hoodie', 'Hoodie'), ('Shorts', 'Shorts'), ('Stickers', 'Stickers'), ('Sporting Goods', 'Sporting Goods')], default='T-Shirts', max_length=25, unique=True),
        ),
        migrations.AlterField(
            model_name='product',
            name='name',
